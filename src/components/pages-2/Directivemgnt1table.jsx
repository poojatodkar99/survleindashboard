...
const rows = [
  createData("myuser",   '12/10/22','Standerd','Imperactive' ),
  createData("myuser",   '01/12/22','Imperactive' ),
  createData("myuser",  '10/12/22','Standerd'),
  createData("myuser",  '12/10/22', 'Imperactive'),
  createData("myuser",   '12/10/22','Imperactive'),
  createData("myuser",   '01/12/22','Standerd' ),
